...
(3, 'Chisel Set', 9, 'For carving and shaping wood or metal materials with precision, this chisel set is an essential tool for woodworkers, sculptors, and artisans. The set includes a variety of blade sizes and shapes for versatility and flexibility in your projects. The sturdy handles provide comfortable grip and control, ensuring accuracy and safety during use. Whether you are carving intricate designs or shaping rough surfaces, this chisel set is up to the task.', 'https://cdn.axminstertools.com/media/catalog/product/cache/6aa9e1e59bcc5998e1687ab5ba3e27a4/9/0/900197_xl.jpg', 'Not Available'),
